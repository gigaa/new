...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            @endif
            <form role="form" method="post" action="{{action('Admin\SliderController@update', $id)}}" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="form-group post clearfix">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div id="imagePreview">
                            ...
                            <img class="img-thumbnail" height="auto" width="200px" src="/sliders/{{$sliders->image}}">
                            @else
                            <p>No image found</p>
                            @endif
                        </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="title_ka" class="form-control" value="<?php echo $sliders->title_ka;?>" " placeholder="შეიყვანეთ სათაური">
                        <label for="exampleInputEmail1">Enter english title</label>
                        <input type="text"  name="title_en" class="form-control"  value="<?php echo $sliders->title_en;?>" " placeholder="enter title">
                    </div>
                </div>
