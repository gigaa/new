            ...
            <form role="form" method="post" action="{{url('/admin/slider')}}" enctype="multipart/form-data">
                ...
                <div class="form-group post clearfix">
                    ...
                    <div class="col-sm-10">
                        <div class="file-input-wrapper">
                            <button class="btn-file-input btn-warning"><i class="fa fa-fw fa-cloud-upload"></i>img Upload</button>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="title_ka" class="form-control"  " placeholder="შეიყვანეთ სათაური">
                        <label for="exampleInputEmail1">Enter english title</label>
                        <input type="text"  name="title_en" class="form-control"  " placeholder="enter title">
                    </div>
                </div>
